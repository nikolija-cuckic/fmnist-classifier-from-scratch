...
class CNNSmall:
    """
    Mali CNN: dva conv bloka i dva fully-connected sloja.
    """
    def __init__(self, num_classes: int = 10):
        ...
        # 28x28 -> pool2: 7x7, kanali 16
        self.fc1 = Dense(16 * 7 * 7, 64)
        self.ln1 = LayerNorm1D(64)
        self.relu3 = ReLU()
    ...
    def params_and_grads(self):
        params = []
        grads = []
        for layer in [self.conv1, self.bn1, self.conv2, self.bn2, self.fc1, self.ln1, self.fc2]:
